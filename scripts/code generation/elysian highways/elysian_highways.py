...
modifiers = [
    {
        ...
        'title': 'Elysian Highways (In Progress)',
...
with open('remove_elysian_highways_modifiers.txt', 'w') as f:
    f.write('to_remove_elysian_highways_modifiers = {\n')
    f.write('# Code generated by elysian_highways.py\n')
    for index, image in enumerate(images):
        for i in fractions:
            f.write(f'\tremove_province_modifier = {modifiers[index]["name"]}_{i}\n')
    f.write('}')

with open('to_set_correct_elysian_highways_modifier.txt', 'w') as f:
